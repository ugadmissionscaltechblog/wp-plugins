...
class Blogger_Box extends Widget_Base {
	
	public function get_style_depends() {
		return [ 'caltech-blogger-box' ];
	}
	...
	protected function register_controls() {
		$this->start_controls_section('section_author_info',
			[
		...
		$this->add_control('homepage_layout',
			[
				'label' => esc_html__( 'Homepage Layout', 'elementor-pro' ),
		...
		$this->add_control('show_biography',
			[
		...
		$this->add_control('author_website',
			[
				'label' => esc_html__( 'Link', 'elementor-pro' ),
		...
		$this->add_control('image_vertical_align',
			[
		...
		$this->add_responsive_control('image_gap',
			[
		...
		$this->add_responsive_control('name_gap',
			[
				'label' => esc_html__( 'Gap', 'elementor-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
		...
		$this->add_control('heading_bio_style',
			[
				'label' => esc_html__( 'Biography', 'elementor-pro' ),
				'type' => Controls_Manager::HEADING,
				'separator' => 'before',
		...
		$this->add_responsive_control('bio_gap',
			[
				'label' => esc_html__( 'Gap', 'elementor-pro' ),
				'type' => Controls_Manager::SLIDER,
				'size_units' => [ 'px', 'em', 'rem', 'custom' ],
		...
		$this->add_control('button_hover_transition_duration',
			[
	...
	protected function render() {
		...
		foreach ($authors as $author) {
			...
			if ( empty( $author['avatar'] ) ) {
				$author['avatar'] = "https://i0.wp.com/studentblog.caltech.edu/wp-content/uploads/2024/08/beaver_logo.webp?w=800&ssl=1";
			}

			if ( 'yes' === $settings['homepage_layout'] ) {
				$this->add_render_attribute( 'box_wrapper', 'class', 'homepage ');
			}
