...
<div class="<?php echo $atts['class']; ?>">
    <ul class="m-a-posts-list" data-list-layout="cards">
                ...
                <?php if ( has_post_thumbnail( $post->ID ) ) : ?>
                    <div class="m-a-posts-list-item-thumb">
                        <a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>">
                            <?php echo get_the_post_thumbnail( $post->ID, 'authorship-post-cards', $attr = ( $add_microdata ? array( 'itemprop' => 'thumbnailUrl' ) : array() ) ) ?>
                        </a>
                    </div>
                <?php endif; ?>
                ...
                <div class="m-a-posts-list-item-data">
                    ...
                    <?php if ( $atts['show_excerpt'] ) : ?>
                        ...
                        <div class="m-a-posts-list-item-excerpt" <?php echo ( $add_microdata ? 'itemprop="abstract"' : '' ); ?>>
                            ...
                            $excerpt_length = $atts['excerpt_length']; //25; //(int) apply_filters( 'excerpt_length', '55' );
