    ...
    describe "without autoOffset", ->
      it "should correctly position opentip without border and stem", ->
        opentip = new Opentip element, "Test",
          delay: 0, target: yes, borderWidth: 0, stem: off, offset: [0, 0], autoOffset: false
        opentip._setup()
      ...
      it "should correctly position opentip with", ->
        opentip = new Opentip element, "Test",
          delay: 0, target: yes, borderWidth: 10, stem: off, offset: [0, 0], autoOffset: false
        opentip._setup()
        elementOffset = adapter.offset element
        opentip.reposition()
      ...
      it "should correctly position opentip on the bottom right", ->
        opentip = new Opentip element, "Test",
          delay: 0, target: yes, borderWidth: 0, stem: off, tipJoint: "bottom right", offset: [0, 0], autoOffset: false
        opentip._setup()
        opentip.dimensions =
      ...
      it "should correctly position opentip on the bottom right with stem", ->
        ...
        expect(elementDimensions).to.eql width: 50, height: 50
        opentip.reposition()
        expect(opentip.currentPosition).to.eql
          left: 300, top: 300 # The autoOffset takes care of accounting for the stem
