...
$this->_options_prefix	= $prefix;
        ...
        private function dropdown()
        {
            ...
            <div class="ui dropdown selection fluid <?php echo $multi; ?> <?php echo $search; ?> <?php echo $this->_data['class']; ?>">
                <input type="hidden" id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" value="<?php echo esc_attr( $value ); ?>">
        ...
        private function inline_dropdown()
        {
            ...
            <div class="ui dropdown inline <?php echo $this->_data['class']; ?>">
                <input type="text" id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" value="<?php echo esc_attr( $saved ); ?>">
        ...
        private function number()
        {
            ...
            <div class="m-number <?php echo ( empty ( $this->_data['class'] ) ? '' : $this->_data['class'] ); ?>">
                ...
                <input type="number" id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" value="<?php echo esc_attr( $this->_value ); ?>" class="" min="<?php echo $this->_min; ?>" max="<?php echo $this->_max; ?>" placeholder="<?php echo $this->_placeholder; ?>">
            </div>
            <?php
            $output .= \ob_get_clean();
            $output .= $this->append();
        ...
        private function text()
        {
            ...
            <div class="m-text">
                ...
                <input type="text" id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" value="<?php echo esc_attr( $this->_value ); ?>" class="" placeholder="<?php echo $this->_placeholder; ?>">
        ...
        private function color()
        {
            ...
            <div class="m-color <?php echo ( empty ( $this->_data['class'] ) ? '' : $this->_data['class'] ); ?>">
                ...
                <input type="text" class="colorpicker" id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" value="<?php echo esc_attr( $this->_value ); ?>">
        ...
        private function textarea()
        {
            ...
            <div class="m-textarea <?php echo ( empty ( $this->_data['class'] ) ? '' : $this->_data['class'] ); ?>">
                ...
                <textarea id="<?php echo $this->_id; ?>" name="<?php echo $this->_id; ?>" rows="<?php echo $this->_data['rows']; ?>" placeholder="<?php echo $this->_placeholder; ?>"><?php echo $this->_value; ?></textarea>
            </div>
            <?php
            $output .= \ob_get_clean();
            $output .= $this->append();
