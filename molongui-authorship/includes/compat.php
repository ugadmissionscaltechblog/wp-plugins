...
if ( apply_filters( 'authorship/plugin_compatibility', authorship_is_feature_enabled( 'plugin_compat' ) ) )
{
    ...
    if ( is_plugin_active( 'learnpress-certificates/learnpress-certificates.php' ) ) require_once $path . 'learnpress-certificates.php';
    ...
    if ( is_plugin_active( 'uncode-core/uncode-core.php' ) ) require_once $path . 'uncode-core.php';
