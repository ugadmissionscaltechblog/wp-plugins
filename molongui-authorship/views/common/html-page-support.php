    ...
    <div class="m-page-content">
        ...
        <div class="m-card m-card-header">
            ...
            <div class="m-card-header__actions">
                <a href="<?php echo 'https://www.molongui.com/help/docs/'; ?>" target="_blank" type="button" class="m-button is-compact is-primary same-width"><?php _e( "Read Docs", 'molongui-authorship' ); ?></a>
            </div>
        </div>
        <div class="m-card">
            <div>
        ...
        <div class="m-card m-card-header">
            ...
            <div class="m-card-header__actions">
                <a href="<?php echo 'https://www.molongui.com/help/support/'; ?>" target="_blank" type="button" class="m-button is-compact same-width"><?php _e( "Get Support", 'molongui-authorship' ); ?></a>
            </div>
        </div>
        <div class="m-card">
            <div>
