...
<div class="m-a-box-item m-a-box-header m-a-box-headline">
    <<?php echo $header_html_tag; ?>>
        ...
        <span class="m-a-box-header-title m-a-box-string-headline">
            <?php echo apply_filters( 'authorship/box/header', ( $options['author_box_header_title'] ? esc_attr( $options['author_box_header_title'] ) : __( "About the author", 'molongui-authorship' ) ), $author ); ?>
        </span>
